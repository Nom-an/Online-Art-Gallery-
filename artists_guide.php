...
<body class="guide-background">
           ...
           <p class="word2">
                        1. Register and upload your artwork on <a style="color:#ffff00;" href="home.php">Rainbow</a><br>
                        2. Ship the artwork to the buyer.<br>
                        3. Receive 80% of the selling price.<br>
            </p>

            <h3 class="word1">How do I apply to exhibit my artwork at Rainbow?</h3>
                <p class="word2">Please click the "Sign Up" link at the top right of this page.</p>

            <h3 class="word1">Can artists living outside of the Bangladesh apply?</h3>
                <p class="word2">No. Our application is only open to artists from Bangladesh.</p>
            ...
            <h3 class="word1">What is your commission structure?</h3>
                <p class="word2"> Rainbow Gallery will pay you 80% of the selling price.  Pay for shipping and get your profit!<br><br>

            Example 1:<br>
            You live in Dhaka City.<br>
            A buyer from Dhaka purchased one of your artworks.<br>
            Selling price: 2500/-<br>
            You keep 80% of this amount: 2000/- This is the amount you will receive from us.<br>
            You pay the shipping costs: 150/- (based on courier rates in February 2021 for a 2kg  weight artwork).<br>
            Your profit: 1850/-<br><br>


            Example 2:<br>
            You live in Dhaka City.<br>
            A buyer from Khulna City purchased one of your artworks.<br>
            Selling price: 2500/-<br>
            You keep 80% of this amount: 2000/- This is the amount you will receive from us.<br>
            You pay the shipping costs: 300/-(based on courier rates in February 2021 for a 2kg weight artwork).<br>
            Your profit: 1700/-</p>
            ...
            <h3 class="word1" >Where is Rainbow based?</h3>
                <p class="word2">Our main office is located in Badda,Gulshan,Dhaka although we are primarily a virtual gallery.</p>

            <h3 class="word1">If I exhibit my work at Rainbow, may I seek other gallery representation?</h3>
                <p class="word2">Yes.</p>
            ...
            <h3 class="word1">Can clients living outside of the United States purchase my art on Rainbow?</h3>
                <p class="word2">No! We don't allow international customers.</p>

            <h3 class="word1">How do I submit more art if I am already exhibiting my work at Rainbow?</h3>
