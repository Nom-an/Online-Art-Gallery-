...
<body class="guide-background">
            ...
            <p >
              ...
              <h2 class="head-guide">Guide</h2><br> <hr class="hr" style="border-bottom: 2px solid #000000;">
           </p>
           ...
           <p class="word2">
            ...
            <h3 class="word1">Do you ship internationally?</h3>
                <p class="word2">No. Our destination is only open inside the Bangladesh only.</p>
